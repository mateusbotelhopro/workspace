...
```
/publicar-site clientes/cliente-x/landing.html
```
...
Pra ter um domínio próprio (ex: seusite.com.br), conecte seu domínio no painel do Cloudflare Pages depois de publicar. A skill continua funcionando igual.
