...
- `interno/` — operação própria, organizada por área (`trafego/`, `comercial/`, `marketing/`, `fiscal/` — documentos fiscais da empresa: notas fiscais, guias de imposto, extratos, contrato social)
