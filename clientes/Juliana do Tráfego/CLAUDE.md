...
- **Nome:** Juliana do Tráfego
- **Segmento:** [a definir]
- **Contato principal:** Juliana
...
- [x] Sistema financeiro (Next.js + Supabase → Vercel)
- [x] CRM (baseado na Comu)
- [x] Site institucional — Grupo Mariano
- [x] Site de captação — Juliana do Tráfego
- [x] Formulário de captação

## Estrutura de pastas

- `sistema-financeiro/` — sistema financeiro (Next.js + Supabase, deploy: Vercel)
- `crm/` — CRM baseado na Comu
- `grupo-mariano/` — site institucional do Grupo Mariano
- `site-captacao/` — site de captação da Juliana
- `formulario/` — formulário de qualificação (deploy: `forms.julianadotrafego.com`)
- `fotos/` — fotos da Juliana organizadas e nomeadas
- `design-guide.md` — identidade visual completa

## Acessos e contas conectadas

- **WhatsApp:** +55 99 99230-3304
- **Instagram:** @julianadotrafego
- **Formulário:** forms.julianadotrafego.com (deploy da pasta `formulario/`)
...
Definida em [design-guide.md](design-guide.md). Sem logo — usa nome em texto (Playfair Display 600, uppercase, letter-spacing 2px). Paleta terrosa premium (#5C3D2E principal), tipografia Playfair Display + Inter, estilo clean com bastante espaço em branco. Fotos organizadas em `fotos/`.
