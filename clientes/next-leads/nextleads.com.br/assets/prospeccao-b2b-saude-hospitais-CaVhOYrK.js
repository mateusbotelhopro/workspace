import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as i}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as r}from"./FunnelLinks-IeluMWpk.js";import{W as n}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function h(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(i,{title:"Prospecção B2B para Hospitais: ICP, Cadência e Scripts",description:"Guia de prospecção B2B para hospitais: ICP, cadência, objeções e scripts para LinkedIn, e-mail e WhatsApp. Otimize suas vendas no setor da saúde.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-saude-hospitais"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Hospitais: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia de prospecção B2B para hospitais: ICP, cadência, objeções e scripts para LinkedIn, e-mail e WhatsApp. Otimize suas vendas no setor da saúde."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b-saude",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Hospitais: ICP, Cadência e Scripts
...
| Dia | Canal | Ação |
| :-- | :--- | :--- |
| 1 | LinkedIn | Conexão com mensagem personalizada, mencionando um desafio comum do setor. |
| 3 | E-mail | Envio de um artigo ou estudo de caso relevante para o cargo do decisor. |
| 5 | LinkedIn | Interação com uma publicação do prospect ou da instituição. |
| 7 | E-mail | Apresentação da sua solução de forma concisa, focando em um benefício específico. |
| 10 | Telefone | Ligação rápida para apresentar-se e validar o interesse. |
| 12 | E-mail | Follow-up com um convite para uma breve demonstração ou diagnóstico. |
| 14 | LinkedIn | Mensagem de despedida (temporária), deixando a porta aberta para futuras conversas. |
