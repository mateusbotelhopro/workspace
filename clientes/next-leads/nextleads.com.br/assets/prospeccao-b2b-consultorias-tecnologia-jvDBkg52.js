import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Consultorias de Tecnologia: Guia Completo",description:"Guia completo sobre prospecção B2B para consultorias de tecnologia. Aprenda a definir seu ICP, criar cadências eficazes e usar scripts que convertem.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-consultorias-tecnologia"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Consultorias de Tecnologia: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B para consultorias de tecnologia. Aprenda a definir seu ICP, criar cadências eficazes e usar scripts que convertem."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/transformacao-digital",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Consultorias de Tecnologia: ICP, Cadência e Scripts
...
| Dia | Canal | Tipo de Toque | Objetivo | Exemplo de Conteúdo | Status | Prioridade | Feedback | Próximo Passo |
|---|---|---|---|---|---|---|---|---|
| 1 | Email | Conexão Personalizada | Despertar interesse | Introdução breve, menção a um problema comum do ICP | Enviado | Alta | Aguardando | Se não responder, seguir para Dia 3 |
| 2 | LinkedIn | Conexão + Mensagem | Construir relacionamento | Pedido de conexão, mensagem curta com valor | Enviado | Média | Aguardando | Se aceitar, enviar mensagem de valor no Dia 4 |
| 3 | Email | Follow-up com Valor | Reforçar proposta de valor | Artigo relevante, estudo de caso, convite para webinar | Enviado | Alta | Aguardando | Se não responder, seguir para Dia 5 |
| 4 | LinkedIn | Mensagem de Valor | Engajar com conteúdo | Comentário em post do prospect, compartilhamento de insight | Enviado | Média | Aguardando | Se engajar, propor call no Dia 6 |
| 5 | Telefone | Cold Call (se possível) | Qualificação rápida | Apresentação concisa, pergunta aberta sobre desafios | Tentativa | Alta | Não atendeu | Deixar voicemail, seguir para Dia 7 |
| 6 | Email | Re-engajamento | Última tentativa de valor | Depoimento de cliente, oferta de diagnóstico gratuito | Enviado | Alta | Aguardando | Se não responder, pausar cadência |
| 7 | LinkedIn | Último Toque | Manter porta aberta | Mensagem de "sem pressão", convite para seguir página | Enviado | Média | Aguardando | Se não responder, adicionar a lista de nutrição a longo prazo |
...
*   [Serviço: Consultoria em Transformação Digital](/servicos/transformacao-digital)
*   [Guia: Como Construir um Funil de Vendas B2B Eficaz](/guias/funil-de-vendas-b2b)
*   [Glossário: Termos Essenciais de Vendas B2B](/glossario/termos-vendas-b2b)
*   [Conteúdo Relacionado: O Futuro da IA em Consultoria](/blog/futuro-ia-consultoria)
*   [Conteúdo Relacionado: Estratégias de Marketing para Consultorias](/blog/marketing-consultorias)


`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-consultorias-tecnologia",currentType:"guia",currentStage:"MOFU"})]})}export{b as default};
