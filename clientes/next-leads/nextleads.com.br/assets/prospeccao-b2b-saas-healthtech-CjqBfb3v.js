import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as i}from"./FunnelLinks-IeluMWpk.js";import{W as t}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function f(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B HealthTech: ICP, Cadência e Scripts | Guia Completo",description:"Guia completo de prospecção B2B para HealthTech. Defina seu ICP, cadência de 7 toques em 14 dias, scripts de LinkedIn, Email e WhatsApp, e tratamento de objeções.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-saas-healthtech"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para HealthTech: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo de prospecção B2B para HealthTech. Defina seu ICP, cadência de 7 toques em 14 dias, scripts de LinkedIn, Email e WhatsApp, e tratamento de objeções."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-healthtech",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(t,{children:`# Prospecção B2B para HealthTech: O Guia Definitivo para Conquistar Clientes de Alto Valor
...
| 5 | LinkedIn | Envio de um artigo ou case study relevante | Após a conexão, envie um InMail ou mensagem com um conteúdo que aborde diretamente um desafio. Não venda, eduque. Ex: "[Nome do Prospect], encontrei este artigo sobre [tópico] que me fez lembrar de nossa conversa sobre [desafio]. Talvez seja útil para você." |
...
| 12 | LinkedIn | Interação com um post do prospect | Mantenha o prospect no radar. Curta ou faça um comentário inteligente em uma de suas publicações recentes. |
...
3.  **"Envie um e-mail com a apresentação."**
...
5.  **"Preciso falar com outras pessoas/departamentos."**
...
6.  **"Não vejo o valor para a minha organização."**
...
**5. Como lidar com o longo ciclo de vendas em HealthTech?**
