import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as d}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Advocacia: ICP, Cadência e Scripts",description:"Guia completo sobre prospecção B2B para advocacia: aprenda a definir seu ICP, criar cadências eficazes e usar scripts de LinkedIn, e-mail e WhatsApp. Otimize sua captação de clientes.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-servicos-prof-advocacia"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Advocacia: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B para advocacia: aprenda a definir seu ICP, criar cadências eficazes e usar scripts de LinkedIn, e-mail e WhatsApp. Otimize sua captação de clientes."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(d,{children:`# Prospecção B2B para Advocacia: ICP, Cadência e Scripts
...
|-----|----------------------|---------------|----------|-------------|
| 1   | LinkedIn             | Conexão       | Estabelecer contato inicial | Personalizar a mensagem de conexão, mencionando um ponto em comum ou um conteúdo relevante. |
| 2   | E-mail               | Primeiro E-mail | Apresentar valor | E-mail curto e direto, focado em uma dor específica da persona e como o escritório pode ajudar. Incluir um CTA claro para agendar uma conversa. |
| 3   | LinkedIn             | Mensagem Direta | Reforçar e agregar valor | Enviar uma mensagem no LinkedIn referenciando o e-mail anterior e compartilhando um artigo ou insight relevante. |
| 5   | E-mail               | Segundo E-mail | Oferecer recurso | E-mail com um estudo de caso, e-book ou webinar que aborde a dor da persona. CTA para agendar. |
...
| 10  | E-mail               | Terceiro E-mail | Última tentativa de valor | E-mail de 'breakup' ou de 'última chance', com um tom mais leve, mas reforçando o valor e a urgência. |
| 14  | LinkedIn             | Mensagem Direta | Fechamento do ciclo | Mensagem final no LinkedIn, indicando que o ciclo de prospecção será encerrado, mas deixando a porta aberta para contato futuro. |
...
Para avaliar o sucesso da prospecção B2B em advocacia, é fundamental acompanhar métricas como a Taxa de Conversão de Lead para Oportunidade (LTO), que indica a qualidade dos leads; a Taxa de Resposta, que mede a eficácia das mensagens; a Taxa de Agendamento de Reuniões/Diagnósticos, que é um indicador direto de interesse; o Ciclo Médio de Vendas, para entender a duração do processo; e o Custo de Aquisição de Cliente (CAC), para garantir a sustentabilidade financeira dos esforços de prospecção.`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-servicos-prof-advocacia",currentType:"guia",currentStage:"MOFU"})]})}export{b as default};
