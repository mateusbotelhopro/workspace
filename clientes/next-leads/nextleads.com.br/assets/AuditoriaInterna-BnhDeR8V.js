import{r as e,j as a,L as o}from"./react-vendor-zTf2QiWo.js";import{B as r}from"./index-Byb5O0fm.js";import{S as i}from"./SEO-Dh6kmgkR.js";import{W as s}from"./index-iDl5n-Fs.js";import{A as t}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";function g(){return e.useEffect(()=>{window.scrollTo(0,0)},[]),a.jsxs("div",{className:"flex flex-col w-full",children:[a.jsx(i,{title:"Guia Completo: Auditoria Interna Eficaz para Empresas | Next Leads",description:"Guia completo sobre Auditoria Interna: otimize processos, mitigue riscos e garanta conformidade. Fortaleça a governança da sua empresa com nosso conteúdo especializado.",canonical:"https://nextleads.com.br/guias/auditoria-interna"}),a.jsx("section",{className:"relative min-h-[50vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:a.jsx("div",{className:"container",children:a.jsx("div",{className:"max-w-3xl",children:a.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6",children:"Guia Completo: Auditoria Interna Estratégica para Governança e Eficiência"})})})}),a.jsx("section",{className:"py-12",children:a.jsx("div",{className:"container max-w-4xl",children:a.jsx(s,{children:`# Guia Completo: Auditoria Interna Estratégica para Governança e Eficiência
...
\`\`\``})})}),a.jsx("section",{className:"py-12 bg-primary/5",children:a.jsxs("div",{className:"container max-w-4xl text-center",children:[a.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para Começar?"}),a.jsx(o,{href:"/contato",children:a.jsxs(r,{size:"lg",children:["Agendar Reunião com Especialista",a.jsx(t,{className:"ml-2 h-4 w-4"})]})})]})})]})}export{g as default};
