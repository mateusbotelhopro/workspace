import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as i}from"./FunnelLinks-IeluMWpk.js";import{W as d}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B LegalTech: ICP, Cadência e Scripts - Guia Completo",description:"Guia completo sobre prospecção B2B em LegalTech: ICP, cadência, objeções e scripts. Otimize suas vendas e escale seu negócio no setor jurídico.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-saas-legaltech"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para LegalTech: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B em LegalTech: ICP, cadência, objeções e scripts. Otimize suas vendas e escale seu negócio no setor jurídico."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/legaltech",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(d,{children:`# Prospecção B2B para LegalTech: ICP, Cadência e Scripts
...
| Dia | Canal de Contato | Tipo de Toque | Objetivo | Conteúdo Sugerido |
|---|---|---|---|---|
| **Dia 1** | LinkedIn (Conexão) | Pedido de Conexão | Iniciar relacionamento profissional | Mensagem personalizada mencionando interesse mútuo no setor jurídico/tecnologia. |
| **Dia 2** | Email (Frio) | Introdução e Problema | Apresentar solução para uma dor específica | Email curto e direto, destacando um problema comum do ICP e como a solução LegalTech pode ajudar. Incluir link para um artigo relevante ou estudo de caso. |
| **Dia 4** | LinkedIn (Mensagem) | Valor Adicionado | Compartilhar insights relevantes | Mensagem com um insight sobre o mercado jurídico ou um conteúdo exclusivo que aborde um desafio do prospect. |
| **Dia 6** | Email (Follow-up) | Prova Social/Benefício | Reforçar valor com exemplos | Email com um depoimento de cliente similar ou um dado estatístico que comprove o ROI da solução. |
| **Dia 8** | Telefone (Cold Call) | Qualificação/Descoberta | Entender necessidades e agendar conversa | Ligação breve para verificar se o problema abordado é relevante e tentar agendar uma conversa mais aprofundada. Preparar roteiro com perguntas abertas. |
| **Dia 10** | Email (Recurso) | Educação/Engajamento | Oferecer material educativo | Enviar um e-book, webinar ou convite para um evento online que seja de interesse do prospect e que reforce a expertise da empresa. |
| **Dia 14** | LinkedIn (Mensagem) | Última Tentativa/Fechamento | Propor próximo passo claro | Mensagem final, recapitulando o valor e propondo um próximo passo claro, como uma demonstração personalizada ou uma reunião de diagnóstico. |
...
Para garantir a eficácia dos scripts, eles devem ser adaptáveis, focando na personalização e na entrega de valor para o prospect. Devem abordar as dores específicas do ICP e apresentar a solução como um caminho para superá-las. É importante testar diferentes abordagens, analisar as taxas de resposta e ajustar os scripts continuamente com base no feedback e nos resultados. A linguagem deve ser profissional, consultiva e alinhada ao tom da empresa.`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-saas-legaltech",currentType:"guia",currentStage:"MOFU"})]})}export{b as default};
