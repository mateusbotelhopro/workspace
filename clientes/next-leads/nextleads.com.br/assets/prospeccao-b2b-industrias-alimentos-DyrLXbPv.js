import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Indústrias de Alimentos: Guia Completo",description:"Domine a prospecção B2B na indústria de alimentos. Aprenda a definir seu ICP, criar cadências eficazes, usar scripts prontos e superar objeções. Agende um diagnóstico!",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-industrias-alimentos"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Indústrias de Alimentos: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Domine a prospecção B2B na indústria de alimentos. Aprenda a definir seu ICP, criar cadências eficazes, usar scripts prontos e superar objeções. Agende um diagnóstico!"}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Indústrias de Alimentos: ICP, Cadência e Scripts
...
| :--- | :--- | :--- |
| 1 | LinkedIn | Conexão com mensagem personalizada, mencionando um ponto em comum ou uma conquista recente da empresa. |
| 2 | E-mail | E-mail de apresentação com um case de sucesso relevante para o setor do prospect, focando nos resultados alcançados. |
| 4 | LinkedIn | Interação com uma publicação do prospect ou da empresa (curtida, comentário relevante). |
| 6 | E-mail | Follow-up do e-mail anterior, oferecendo um material rico (e-book, whitepaper, webinar) sobre um tema de interesse do prospect. |
| 8 | Telefone | Ligação rápida para apresentar a solução de forma concisa e agendar uma conversa mais aprofundada. |
| 11 | WhatsApp | Mensagem curta e amigável, mencionando o contato anterior e reforçando o valor da sua solução. |
| 14 | E-mail | E-mail de "break-up" amigável, informando que você não entrará mais em contato, mas deixando a porta aberta para futuras conversas. |
...
[^1]: [Importância da prospecção B2B na Indústria Alimentícia](https://www.eacm360.com.br/post/prospeccao-b2b-eficiente-na-industria-alimenticia)
[^2]: [Vendas B2B: o coração do crescimento na indústria alimentícia](https://fmgmarketing.com.br/blog/vendas-b2b-o-coracao-do-crescimento-na-industria-alimenticia/)
[^3]: [O que é ICP e por que você está prospectando errado](https://www.nuvia.co/blog/o-que-e-icp-e-por-que-voce-esta-prospectando-errado)
[^4]: [3 soluções para prospecção de leads B2B na indústria de alimentos](https://www.cortex-intelligence.com/blog/industria/prospeccao-leads-b2b)
[^5]: [Como a estratégia certa pode tornar as vendas B2B no food service mais eficazes](https://montecarloalimentos.com.br/blog/como-tornar-as-vendas-b2b-no-food-service-mais-eficazes/)
[^6]: [Marketing digital para fábrica de alimentos: estratégias B2B](https://agenciaexplorer.com.br/blog/industria/marketing-digital-fabrica-alimentos/)
[^7]: [Cadência de Prospecção B2B: O guia definitivo para criar sua!](https://dealwise.com.br/cadencia-de-prospeccao-b2b/)
[^8]: [Cadências B2B que ainda funcionam em 2025: o que mudou (e o ...](https://receitaprevisivel.com/blog/blog-cadencias-b2b-2025-o-que-ainda-funciona/)
[^9]: [Prospecção Outbound B2B: Playbook de Cadência - Winning Sales](https://winningsales.com.br/blog/prospeccao-outbound/)
[^10]: [Prospecção de clientes B2B: quais estratégias adotar?](https://agenciamutum.com/blog/prospeccao-de-clientes-b2b-quais-estrategias-adotar/)
`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-industrias-alimentos",currentType:"guia",currentStage:"MOFU"})]})}export{b as default};
