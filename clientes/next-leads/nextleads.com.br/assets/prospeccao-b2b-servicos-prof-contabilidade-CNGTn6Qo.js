import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as i}from"./FunnelLinks-IeluMWpk.js";import{W as t}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B Contabilidade: ICP, Cadência e Scripts | Guia",description:"Aprenda prospecção B2B para contabilidade: defina seu ICP, cadência de 7 toques e scripts para LinkedIn, Email e WhatsApp. Guia completo para contadores.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-servicos-prof-contabilidade"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Contabilidade: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Aprenda prospecção B2B para contabilidade: defina seu ICP, cadência de 7 toques e scripts para LinkedIn, Email e WhatsApp. Guia completo para contadores."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/contabilidade-consultiva",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(t,{children:`# Guia de Prospecção B2B para Contabilidade: ICP, Cadência e Scripts
...
| Dia | Canal | Ação | Objetivo | Dica de Conteúdo/Abordagem |
| :-- | :--- | :--- | :--- | :--- |
| 1 | LinkedIn | Visita ao perfil + Convite para conexão com nota personalizada | Iniciar o relacionamento e gerar reconhecimento da marca. | "Olá, [Nome do Prospect]. Vi que você também atua no setor de [Setor do Prospect] e me interessei pelo seu trabalho na [Empresa do Prospect]. Adoraria me conectar para trocarmos experiências e insights sobre [tópico relevante para o setor]. Abraço!" |
| 3 | E-mail | E-mail de apresentação focado na dor da persona | Apresentar a proposta de valor e a solução para uma dor específica. | E-mail com assunto chamativo (ex: "Como [Empresa do Prospect] pode economizar impostos em [Setor do Prospect]?") e corpo focado em um problema comum da persona, oferecendo sua contabilidade como solução. Inclua um link para um artigo relevante do seu blog. |
| 5 | LinkedIn | Interação com um post ou artigo compartilhado pelo prospect | Gerar engajamento e demonstrar interesse genuíno. | Comente de forma construtiva em uma publicação recente do prospect, ou compartilhe um artigo relevante que ele possa se interessar, mencionando-o. |
| 7 | E-mail | E-mail de follow-up com um case de sucesso ou conteúdo relevante | Reforçar a autoridade e o valor da sua solução. | E-mail com um case de sucesso de um cliente com perfil similar, destacando os resultados alcançados. Ou envie um e-book/webinar sobre um tema que resolva uma dor da persona. |
| 10 | WhatsApp | Mensagem breve, se o contato for receptivo a este canal | Quebrar o gelo e oferecer um canal de comunicação mais direto. | "Olá, [Nome do Prospect], tudo bem? Meu nome é [Seu Nome]. Falei com você por e-mail sobre otimização contábil. Seria um bom momento para uma rápida conversa?" (Use apenas se houver indicação ou permissão para contato via WhatsApp). |
| 12 | E-mail | E-mail de "break-up" amigável, deixando a porta aberta para o futuro | Última tentativa de engajamento, com um tom leve e sem pressão. | "Olá, [Nome do Prospect]. Percebi que talvez este não seja o momento ideal para conversarmos sobre [tópico]. De qualquer forma, gostaria de deixar a porta aberta para o futuro. Se precisar de algo relacionado a [sua especialidade], pode me procurar. Abraço!" |
| 14 | LinkedIn | Última tentativa de contato, sugerindo uma breve chamada de diagnóstico | Oferecer uma última oportunidade para agendar uma conversa. | Mensagem no LinkedIn: "Olá, [Nome do Prospect]. Gostaria de fazer uma última tentativa para agendarmos uma breve chamada de diagnóstico de 15 minutos. Tenho certeza que podemos identificar oportunidades valiosas para a [Empresa do Prospect]. O que você acha?" |
