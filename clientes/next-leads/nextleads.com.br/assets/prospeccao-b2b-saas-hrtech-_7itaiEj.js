import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function h(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para HRTech: ICP, Cadência e Scripts",description:"Guia completo de prospecção B2B para HRTech: defina seu ICP, crie cadências multicanal eficazes e utilize scripts prontos para LinkedIn, Email e WhatsApp. Otimize suas vendas!",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-saas-hrtech"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para HRTech: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo de prospecção B2B para HRTech: defina seu ICP, crie cadências multicanal eficazes e utilize scripts prontos para LinkedIn, Email e WhatsApp. Otimize suas vendas!"}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/solucoes-hrtech",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para HRTech: ICP, Cadência e Scripts
...
> Vi seu perfil e fiquei impressionado(a) com sua experiência em [Área de Atuação do Prospect, ex: gestão de talentos] na [Nome da Empresa]. Acompanho de perto as inovações em HRTech e percebo que [mencionar um desafio ou tendência relevante para o prospect]. Gostaria de conectar para trocarmos ideias sobre o futuro do RH.
> Atenciosamente,
> [Seu Nome]
...
> Olá [Nome do Prospect],
> Espero que esteja tudo bem. Estava pensando em [Nome da Empresa do Prospect] e em como [mencionar um desafio comum de HRTech, ex: a gestão de desempenho pode ser um gargalo]. Nossa plataforma tem ajudado empresas como a sua a [mencionar benefício específico, ex: reduzir em X% o tempo gasto com avaliações]. Você estaria aberto(a) a uma breve conversa para explorar como isso se aplica à sua realidade?
> [Seu Nome]
...
[1] Luiza C. - SDR | B2B | SaaS | HR Tech | Inbound & Outbound. LinkedIn. Disponível em: [https://br.linkedin.com/in/luizacordgeracaodedemanda](https://br.linkedin.com/in/luizacordgeracaodedemanda)
[2] How to Define A SaaS Ideal Customer Profile (ICP) - PayPro Global. Disponível em: [https://payproglobal.com/how-to/define-saas-ideal-customer-profile-icp/](https://payproglobal.com/how-to/define-saas-ideal-customer-profile-icp/)
[3] Como montar uma cadência multicanal que gera conversas (e não só mensagens) - Traquisition. Disponível em: [https://www.tracquisition.com/blog/como-montar-uma-cad%C3%AAncia-multicanal-que-gera-conversa](https://www.tracquisition.com/blog/como-montar-uma-cad%C3%AAncia-multicanal-que-gera-conversa)
[4] Objeções em Vendas B2B: Como Transformar o "Não, Está Caro ..." - TSK Digital. Disponível em: [https://tsk.digital/blog/objecoes-em-vendas-b2b/](https://tsk.digital/blog/objecoes-em-vendas-b2b/)
[5] Cracking the Code of B2B SaaS ICP: A Comprehensive Guide by Effiqs. Disponível em: [https://www.effiqs.com/resources/a-guide-to-successful-b2b-saas-icp](https://www.effiqs.com/resources/a-guide-to-successful-b2b-saas-icp)`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-saas-hrtech",currentType:"guia",currentStage:"MOFU"})]})}export{h as default};
