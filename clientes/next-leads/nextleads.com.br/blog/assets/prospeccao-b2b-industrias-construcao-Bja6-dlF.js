import{j as e,L as o}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as a}from"./index-Byb5O0fm.js";import{F as i}from"./FunnelLinks-IeluMWpk.js";import{W as t}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B Construção: ICP, Cadência e Scripts",description:"Guia completo sobre prospecção B2B para indústrias de construção. Aprenda a definir seu ICP, criar cadências eficazes e usar scripts que convertem.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-industrias-construcao"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Indústrias de Construção: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B para indústrias de construção. Aprenda a definir seu ICP, criar cadências eficazes e usar scripts que convertem."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(o,{href:"/contato",children:e.jsxs(a,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(o,{href:"/servicos/prospeccao-b2b",children:e.jsx(a,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(t,{children:`# Prospecção B2B para Indústrias de Construção: ICP, Cadência e Scripts
...
*   **Dia 1 - Toque 1 (LinkedIn - Conexão Personalizada):** Envie um convite de conexão personalizado, mencionando um ponto em comum (ex: setor, publicação recente, conexão mútua) ou um desafio relevante para o setor de construção. Exemplo: Olá [Nome do Prospect], vi que você atua como [Cargo do Prospect] na [Nome da Empresa] e soube do seu trabalho em [Mencionar Projeto ou Conquista]. Tenho acompanhado as inovações no setor de construção e acredito que podemos ter uma conversa interessante sobre [Desafio Comum].

*   **Dia 3 - Toque 2 (Email - Valor e Dor):** Envie um e-mail focado em um problema comum que sua solução resolve, oferecendo um insight valioso ou um estudo de caso relevante para o setor de construção. Mantenha-o conciso e com um CTA claro.
...
*   **Dia 5 - Toque 3 (LinkedIn - Conteúdo Relevante):** Compartilhe um artigo, post de blog ou relatório relevante para o setor de construção e marque o prospect, adicionando um comentário que instigue a reflexão.
...
*   **Dia 7 - Toque 4 (Email - Prova Social/Testemunho):** Envie um e-mail com um testemunho ou prova social de um cliente satisfeito no setor de construção, destacando os resultados alcançados.
...
*   **Dia 9 - Toque 5 (Telefone - Ligação Rápida):** Faça uma ligação rápida e objetiva, referenciando os contatos anteriores e buscando entender melhor as necessidades do prospect. Deixe um voicemail se não conseguir contato.
...
*   **Dia 11 - Toque 6 (Email - Última Tentativa/Recurso):** Envie um e-mail de despedida, oferecendo recursos adicionais e deixando a porta aberta para contato futuro.
...
*   **Dia 14 - Toque 7 (LinkedIn - Engajamento Passivo):** Continue interagindo com o conteúdo do prospect no LinkedIn (curtir, comentar) para manter a visibilidade e construir relacionamento a longo prazo.
...
1.  **"Já temos um fornecedor/solução para isso."**
...
4.  **"Não vejo como isso se aplica aos nossos projetos específicos."**
...
5.  **"Preciso falar com [Outra Pessoa/Departamento]."**
...
1.  **Taxa de Conversão de Lead para Oportunidade:** Mede a porcentagem de leads qualificados que avançam para a fase de oportunidade no funil de vendas. Indica a qualidade dos leads e a eficácia da abordagem inicial.
2.  **Ciclo de Vendas Médio:** O tempo médio que leva desde o primeiro contato com um prospect até o fechamento do negócio. No setor da construção, este ciclo tende a ser mais longo, e monitorá-lo ajuda a otimizar o processo.
3.  **Valor Médio do Contrato (VMC):** O valor médio dos contratos fechados. Ajuda a entender o retorno financeiro da prospecção e a direcionar esforços para projetos de maior valor.
4.  **Custo de Aquisição de Cliente (CAC):** O custo total de vendas e marketing dividido pelo número de novos clientes adquiridos. Essencial para garantir a sustentabilidade e rentabilidade da prospecção.
5.  **Taxa de Retenção de Clientes:** A porcentagem de clientes que continuam a fazer negócios com sua empresa ao longo do tempo. No setor da construção, a retenção é vital devido ao alto valor dos projetos e à importância dos relacionamentos de longo prazo.
...
`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(o,{href:"/contato",children:e.jsxs(a,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-industrias-construcao",currentType:"guia",currentStage:"MOFU"})]})}export{b as default};
