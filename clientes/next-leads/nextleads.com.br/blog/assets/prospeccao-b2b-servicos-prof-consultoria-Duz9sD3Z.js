import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Consultoria: ICP, Cadência e Scripts",description:"Aprenda prospecção B2B para consultoria: ICP, cadência de 7 toques em 14 dias, scripts de LinkedIn, Email e WhatsApp, e tratamento de objeções.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-servicos-prof-consultoria"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Consultoria: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Aprenda prospecção B2B para consultoria: ICP, cadência de 7 toques em 14 dias, scripts de LinkedIn, Email e WhatsApp, e tratamento de objeções."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Consultoria: ICP, Cadência e Scripts
...
|---|---|---|---|---|
| 1 | Email | Personalizado | Introdução e Proposta de Valor | Apresentação breve, menção a um desafio comum do ICP, convite para diagnóstico rápido. |
| 2 | LinkedIn | Conexão | Construir Rede | Pedido de conexão com mensagem personalizada, referenciando o email anterior. |
| 3 | Email | Conteúdo de Valor | Educação | Compartilhar um artigo, estudo de caso ou webinar relevante para o desafio do prospect. |
| 5 | LinkedIn | Mensagem | Engajamento | Comentário em postagem recente do prospect ou mensagem com insight sobre o setor. |
| 7 | Email | Follow-up | Reafirmar Valor | Relembrar a proposta de valor, oferecer um recurso exclusivo (e-book, template). |
| 10 | WhatsApp (se disponível) | Mensagem Curta | Conveniência | Mensagem breve perguntando se o prospect teve chance de revisar o material, oferecendo-se para uma conversa rápida. |
| 14 | Email | Última Tentativa | Chamada Final | "Breakup email" com uma última oferta de valor e um convite claro para agendar. |
...
Scripts prontos servem como uma base sólida, mas a personalização é fundamental na prospecção de consultoria. Use os scripts como um ponto de partida e adapte-os com informações específicas sobre o prospect e sua empresa, demonstrando que você fez sua pesquisa e entende suas necessidades. A autenticidade e a relevância aumentam significativamente as taxas de resposta.`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-servicos-prof-consultoria",currentType:"guia",currentStage:"MOFU"})]})}export{b as default};
