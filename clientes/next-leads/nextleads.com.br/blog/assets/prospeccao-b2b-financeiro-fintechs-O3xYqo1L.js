import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as i}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as r}from"./FunnelLinks-IeluMWpk.js";import{W as n}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function h(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(i,{title:"Prospecção B2B para Fintechs: ICP, Cadência e Scripts",description:"Aprenda a prospectar Fintechs B2B com este guia completo. Descubra como definir seu ICP, criar cadências eficazes e usar scripts que convertem. Otimize suas vendas!",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-financeiro-fintechs"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Fintechs: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Aprenda a prospectar Fintechs B2B com este guia completo. Descubra como definir seu ICP, criar cadências eficazes e usar scripts que convertem. Otimize suas vendas!"}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b-saas-tecnologia",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Fintechs: ICP, Cadência e Scripts
...
| Dia | Canal | Ação |
| :-- | :--- | :--- |
| 1 | LinkedIn | **Conexão + Nota:** Envie um convite de conexão personalizado, mencionando um ponto em comum ou uma conquista recente da Fintech. |
| 3 | E-mail | **E-mail 1 (Introdução):** Apresente-se e à sua solução, focando em um dos principais desafios da persona. Use um título impactante e um corpo de e-mail curto e direto. |
| 5 | LinkedIn | **Interação:** Curta e comente uma publicação recente do lead ou da empresa, agregando valor com um insight relevante. |
| 7 | E-mail | **E-mail 2 (Caso de Uso):** Envie um e-mail com um breve caso de uso ou estatística que demonstre o valor da sua solução para uma empresa similar. |
| 10 | WhatsApp | **Mensagem Breve (se aplicável):** Se o contato for receptivo, uma mensagem curta e profissional pode ser enviada, reforçando o valor e perguntando sobre a disponibilidade para uma conversa rápida. |
| 12 | E-mail | **E-mail 3 (Recurso de Valor):** Compartilhe um artigo, um whitepaper ou um relatório de mercado relevante para o lead, sem pedir nada em troca. |
| 14 | E-mail | **E-mail 4 (Última Tentativa):** E-mail de "break-up" amigável, informando que esta é a última tentativa de contato e deixando a porta aberta para futuras conversas. |
...
Para complementar sua estratégia de prospecção B2B para Fintechs, explore outros conteúdos relevantes que podem otimizar seus resultados:

*   **Serviço:** [Prospecção B2B para SaaS e Tecnologia](/servicos/prospeccao-b2b-saas-tecnologia)
*   **Guia:** [Guia Completo de Cold Email para Vendas B2B](/guias/guia-cold-email-vendas-b2b)
*   **Glossário:** [Glossário de Termos de Vendas e Marketing](/glossario/termos-vendas-marketing)
*   **Conteúdo Relacionado:** [Como Construir um ICP Eficaz](/blog/como-construir-icp-eficaz)
*   **Conteúdo Relacionado:** [As Melhores Ferramentas de Automação de Vendas](/blog/melhores-ferramentas-automacao-vendas)
`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(r,{currentUrl:"/guias/prospeccao-b2b-financeiro-fintechs",currentType:"guia",currentStage:"MOFU"})]})}export{h as default};
