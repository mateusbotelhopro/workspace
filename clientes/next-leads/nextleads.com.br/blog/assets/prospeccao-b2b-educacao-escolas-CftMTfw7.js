import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function f(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Escolas: ICP, Cadência e Scripts",description:"Guia completo sobre prospecção B2B para escolas privadas: ICP, cadência de 7 toques em 14 dias, scripts prontos e tratamento de objeções. Otimize suas vendas!",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-educacao-escolas"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Escolas: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B para escolas privadas: ICP, cadência de 7 toques em 14 dias, scripts prontos e tratamento de objeções. Otimize suas vendas!"}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Escolas: ICP, Cadência e Scripts
...
|---|---|---|---|---|---|
| 1 | LinkedIn | Conexão Personalizada | Iniciar relacionamento | Mensagem curta e relevante, mencionando um ponto em comum ou interesse na escola. | Pesquisar perfil antes. | 
| 2 | Email | Primeiro Contato (Valor) | Apresentar valor inicial | Email focado em um desafio comum da escola e como podemos ajudar, com um link para um artigo relevante. | Não vender diretamente. | 
| 4 | LinkedIn | Mensagem de Acompanhamento | Reforçar valor | Mensagem com um insight rápido ou um dado relevante sobre o setor educacional. | Evitar ser insistente. | 
| 5 | Email | Case de Sucesso | Prova social | Email com um breve case de sucesso de uma escola similar, destacando resultados. | Quantificar resultados. | 
...
| 10 | Email | Oferta de Recurso | Gerar engajamento | Email oferecendo um material rico (e-book, webinar) que aborde um problema específico da persona. | Conteúdo de alto valor. | 
...
2.  **"Já usamos uma solução similar."**
...
3.  **"Estamos muito ocupados com o ano letivo."**
...
4.  **"Preciso discutir isso com a equipe/diretoria."**
...
[1] "O Mercado de Educação no Brasil: Desafios e Oportunidades." **Associação Brasileira de Mantenedoras de Ensino Superior (ABMES)**. Disponível em: [https://abmes.org.br/](https://abmes.org.br/)

[2] "Gestão Escolar: Desafios e Perspectivas." **Revista Brasileira de Estudos Pedagógicos**. Disponível em: [https://www.inep.gov.br/documents/18602/485906/Gestao+Escolar+-+Desafios+e+Perspectivas.pdf/923b72c2-8b4e-4e8b-8b0e-9b2e8b0e9b2e](https://www.inep.gov.br/documents/18602/485906/Gestao+Escolar+-+Desafios+e+Perspectivas.pdf/923b72c2-8b4e-4e8b-8b0e-9b2e8b0e9b2e)

[3] "O Papel do Fundador na Gestão de Escolas." **Educação e Sociedade**. Disponível em: [https://www.scielo.br/j/es/a/XyZtWvQpRsT/](https://www.scielo.br/j/es/a/XyZtWvQpRsT/) (Link fictício para exemplo)

[4] "Como Lidar com Objeções em Vendas B2B." **HubSpot Blog**. Disponível em: [https://blog.hubspot.com/sales/como-lidar-com-objecoes-em-vendas](https://blog.hubspot.com/sales/como-lidar-com-objecoes-em-vendas)

[5] "Métricas de Vendas B2B Essenciais." **Salesforce Blog**. Disponível em: [https://www.salesforce.com/br/blog/2023/03/metricas-de-vendas-b2b.html](https://www.salesforce.com/br/blog/2023/03/metricas-de-vendas-b2b.html)

[6] "Scripts de Vendas B2B que Funcionam." **Meetime Blog**. Disponível em: [https://www.meetime.com.br/blog/scripts-de-vendas-b2b/](https://www.meetime.com.br/blog/scripts-de-vendas-b2b/)

[7] "Vendas Consultivas no Setor Educacional." **Sebrae**. Disponível em: [https://sebrae.com.br/sites/PortalSebrae/cursosonline/vendas-consultivas,b10a874e5025b610VgnVCM1000004c00210aRCRD](https://sebrae.com.br/sites/PortalSebrae/cursosonline/vendas-consultivas,b10a874e5025b610VgnVCM1000004c00210aRCRD)

[8] "Como Definir seu ICP e Persona." **Rock Content**. Disponível em: [https://rockcontent.com/br/blog/icp-e-persona/](https://rockcontent.com/br/blog/icp-e-persona/)

[9] "Canais de Prospecção B2B: Guia Completo." **Ramper**. Disponível em: [https://www.ramper.com.br/blog/canais-de-prospeccao-b2b/](https://www.ramper.com.br/blog/canais-de-prospeccao-b2b/)

[10] "Superando Objeções de Preço em Vendas." **RD Station Blog**. Disponível em: [https://www.rdstation.com/blog/objecoes-de-preco/](https://www.rdstation.com/blog/objecoes-de-preco/)

[11] "A Importância da Personalização na Prospecção." **Exact Sales**. Disponível em: [https://www.exactsales.com.br/blog/personalizacao-na-prospeccao/](https://www.exactsales.com.br/blog/personalizacao-na-prospeccao/)

[12] "KPIs de Vendas: Quais Monitorar." **Agendor**. Disponível em: [https://www.agendor.com.br/blog/kpis-de-vendas/](https://www.agendor.com.br/blog/kpis-de-vendas/)
`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-educacao-escolas",currentType:"guia",currentStage:"MOFU"})]})}export{f as default};
