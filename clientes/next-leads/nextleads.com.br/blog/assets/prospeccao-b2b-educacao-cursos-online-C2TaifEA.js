import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as i}from"./FunnelLinks-IeluMWpk.js";import{W as d}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function x(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Cursos Online: ICP, Cadência e Scripts",description:"Domine a prospecção B2B para cursos online com este guia completo. Defina seu ICP, crie cadências eficazes e use scripts prontos para fechar mais vendas.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-educacao-cursos-online"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Cursos Online: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Domine a prospecção B2B para cursos online com este guia completo. Defina seu ICP, crie cadências eficazes e use scripts prontos para fechar mais vendas."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(d,{children:`# Prospecção B2B para Cursos Online: ICP, Cadência e Scripts
...
| Dia | Toque | Canal | Ação |
| :-- | :-- | :-- | :-- |
| 1 | 1 | LinkedIn | Conexão com mensagem personalizada, mencionando um ponto em comum ou uma publicação recente do lead. |
| 2 | 2 | E-mail | E-mail de apresentação com foco na dor principal da persona, oferecendo um insight ou dado relevante. |
| 4 | 3 | LinkedIn | Interação com uma publicação do lead (curtida ou comentário relevante). |
| 6 | 4 | E-mail | E-mail de follow-up com um estudo de caso ou material rico (e-book, webinar) que aprofunde a solução para a dor. |
| 9 | 5 | WhatsApp | Mensagem breve e direta, se o contato for aberto a este canal, perguntando se o material enviado foi útil. |
| 12 | 6 | E-mail | E-mail com uma pergunta provocativa sobre um desafio específico do setor ou da empresa do lead. |
| 14 | 7 | LinkedIn | Mensagem de despedida (temporária), informando que não insistirá no contato, mas que está à disposição para o futuro. |
...
| KPI | Descrição | Como Medir | Importância |
| :-- | :-- | :-- | :-- |
| **Taxa de Resposta** | Percentual de leads que respondem a qualquer toque da cadência. | (Número de Respostas / Número de Leads Contatados) x 100 | Indica a eficácia das mensagens e canais utilizados. |
| **Taxa de Conversão de SQL** | Percentual de leads qualificados de vendas (SQL) que avançam para a próxima etapa do funil. | (Número de SQLs Convertidos / Número Total de SQLs) x 100 | Avalia a qualidade da qualificação e o alinhamento com o ICP. |
| **Custo de Aquisição de Cliente (CAC)** | Custo total de marketing e vendas dividido pelo número de novos clientes adquiridos. | (Custo Total de Marketing + Vendas) / Número de Novos Clientes | Mede a eficiência do investimento em prospecção. |
...
| **Tempo Médio de Ciclo de Vendas** | Duração média desde o primeiro contato até o fechamento da venda. | Soma do tempo de todos os ciclos de vendas / Número de Vendas | Identifica gargalos e oportunidades de otimização no processo. |
