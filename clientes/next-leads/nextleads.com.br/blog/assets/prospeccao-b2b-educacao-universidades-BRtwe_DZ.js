import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as i}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as r}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(i,{title:"Prospecção B2B para Universidades: ICP, Cadência e Scripts",description:"Desvende a prospecção B2B para universidades com nosso guia completo. Aprenda a definir seu ICP, otimizar cadências e usar scripts eficazes para engajar decisores.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-educacao-universidades"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Universidades: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Desvende a prospecção B2B para universidades com nosso guia completo. Aprenda a definir seu ICP, otimizar cadências e usar scripts eficazes para engajar decisores."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b-educacao",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Universidades: ICP, Cadência e Scripts
...
| Característica Principal | Universidades Públicas | Universidades Privadas |
| :----------------------- | :--------------------- | :--------------------- |
| **Financiamento**        | Orçamento público, sujeito a licitações e verbas governamentais. | Receita de mensalidades, investimentos privados e parcerias. |
| **Processo Decisório**   | Mais burocrático, com múltiplos níveis de aprovação e prazos mais longos. | Mais ágil, com maior autonomia para decisões de investimento. |
| **Foco Estratégico**     | Pesquisa, extensão, impacto social, acesso universal. | Retorno sobre investimento, inovação pedagógica, captação e retenção de alunos. |
| **Desafios Comuns**      | Restrições orçamentárias, lentidão na implementação de novas tecnologias. | Concorrência acirrada, necessidade de diferenciação, otimização de custos. |
...
| :-- | :------ | :--- | :------- |
| 1 | LinkedIn | Visita ao perfil + Convite de conexão com nota personalizada | Iniciar o relacionamento de forma sutil e profissional. |
| 2 | E-mail | E-mail de apresentação com foco na dor do ICP | Apresentar a solução de forma consultiva, conectando com os desafios da universidade. |
| 4 | LinkedIn | Interação com uma publicação do decisor ou da universidade | Manter-se no radar do decisor, demonstrando interesse genuíno. |
| 7 | E-mail | Follow-up com um case de sucesso ou conteúdo de valor | Nutrir o lead com informações relevantes, reforçando a autoridade no assunto. |
| 10 | Telefone | Ligação rápida para apresentação e qualificação | Estabelecer um contato mais direto, buscando entender as necessidades do lead. |
| 12 | WhatsApp | Mensagem breve (se houver abertura) com um insight relevante | Utilizar um canal mais informal para compartilhar uma informação de valor. |
| 14 | E-mail | E-mail de "break-up" educado, deixando a porta aberta para futuros contatos | Encerrar a cadência de forma profissional, sem pressionar o lead. |
...
5.  **Email de Follow-up (Após Conteúdo/Evento):**
    \`\`\`
...
6.  **Email de "Break-up" (Final da Cadência):**
    \`\`\`
...
7.  **Mensagem de Primeiro Contato (Pós-Evento/Indicação):**
    \`\`\`
...
8.  **Mensagem de Follow-up (Pós-Email/Ligação):**
    \`\`\`
    Olá [Nome do Decisor],
...
9.  **Mensagem para Compartilhar Conteúdo Relevante:**
    \`\`\`
    Olá [Nome do Decisor],
