import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Consultorias de Estratégia: Guia 2026",description:"Guia completo de prospecção B2B para consultorias de estratégia. Aprenda a definir seu ICP, criar cadências eficazes e usar scripts prontos para LinkedIn, email e WhatsApp.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-consultorias-estrategia"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Consultorias de Estratégia: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo de prospecção B2B para consultorias de estratégia. Aprenda a definir seu ICP, criar cadências eficazes e usar scripts prontos para LinkedIn, email e WhatsApp."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Consultorias de Estratégia: ICP, Cadência e Scripts
...
| Dia | Canal | Objetivo | Conteúdo Sugerido | Observações |
|---|---|---|---|---|
| **Dia 1** | **Email (Personalizado)** | Introdução e Geração de Curiosidade | Email curto, focado na dor do ICP e como a consultoria pode resolver. Mencionar um case de sucesso relevante. | Personalizar o assunto e o primeiro parágrafo com base na pesquisa do prospect. |
| **Dia 2** | **LinkedIn (Conexão)** | Construção de Rede e Reconhecimento | Pedido de conexão personalizado, mencionando um ponto em comum ou interesse mútuo. | Evitar mensagens de vendas diretas. Focar em construir relacionamento. |
| **Dia 4** | **Email (Valor)** | Educação e Demonstração de Expertise | Compartilhar um artigo, estudo de caso ou insight relevante para o setor do prospect. | Posicionar a consultoria como líder de pensamento. |
| **Dia 6** | **LinkedIn (Mensagem)** | Engajamento e Qualificação | Mensagem curta no LinkedIn, referenciando o conteúdo enviado por email e perguntando sobre a perspectiva do prospect. | Abrir espaço para diálogo, não para pitch de vendas. |
| **Dia 8** | **Email (Prova Social)** | Credibilidade e Confiança | Enviar um depoimento, vídeo de cliente ou convite para um webinar/evento relevante. | Focar em como outros clientes se beneficiaram. |
| **Dia 10** | **Telefone (Curto)** | Conexão Direta e Agendamento | Ligação breve para verificar se o conteúdo foi útil e propor uma conversa rápida para explorar desafios. | Preparar-se para objeções e ter um script flexível. |
| **Dia 14** | **Email (Última Tentativa/Breakup)** | Senso de Urgência e Próximos Passos | Email final, oferecendo um último recurso (ex: diagnóstico gratuito) ou indicando que a prospecção será pausada. | Manter um tom profissional e respeitoso. |
...
*   **Serviço:** [Prospecção B2B e Geração de Leads](https://nextleads.com.br/)
*   **Guia:** [Prospecção B2B: manual definitivo para atrair bons leads](https://www.agendor.com.br/blog/prospeccao-b2b/)
*   **Glossário:** [Glossário de vendas B2B](https://www.papsolutions.com.br/glossario-de-vendas-b2b-nt/)
*   **Conteúdo Relacionado 1:** [Estratégia de prospecção B2B: 3 modelos para vender mais](https://www.meetz.com.br/blog/estrategias-prospeccao-b2b)
*   **Conteúdo Relacionado 2:** [Prospecção B2B Automatizada: Como Gerar 300+ Leads Qualificados por Mês](https://wslabs.ai/prospeccao-b2b-automatizada-como-gerar-300-leads-qualificados-por-mes/)

### Referências

[1] [Consultoria para prospecção B2B: maximizando resultados na captação de leads](https://www.publicidademarketing.com.br/blog/vendas/consultoria-para-prospeccao-b2b-maximizando-resultados-na-captacao-de-leads/)
[2] [Perfil de Cliente Ideal (ICP) y por qué es clave para tu estrategia comercial](https://smart-team.io/perfil-de-cliente-ideal-icp-estrategia-comercial/)
[3] [Fluxo de Cadências de Prospecção: o Framework](https://winningsales.com.br/blog/fluxo-cadencias-prospeccao/)
[4] [Desvendando as 5 objeções mais comuns dos clientes B2B](https://blog.asbmarketing.com.br/objecoes-clientes-b2b/)
[5] [7 métricas que você deve acompanhar na prospecção B2B](https://www.meetz.com.br/blog/metricas-prospeccao-b2b)
[6] [Script de prospecção B2B: como obter mais respostas](https://notopo.com/blog/script-de-prospeccao-b2b-como-personalizar-mensagens-e-gerar-mais-respostas)
`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-consultorias-estrategia",currentType:"guia",currentStage:"MOFU"})]})}export{b as default};
