import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as i}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as r}from"./FunnelLinks-IeluMWpk.js";import{W as n}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(i,{title:"Prospecção B2B para Clínicas: ICP, Cadência e Scripts",description:"Desvende a prospecção B2B para clínicas médicas e odontológicas. Este guia aborda ICP, cadência de 7 toques, tratamento de objeções e scripts prontos. Otimize suas vendas!",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-saude-clinicas"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Clínicas: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Desvende a prospecção B2B para clínicas médicas e odontológicas. Este guia aborda ICP, cadência de 7 toques, tratamento de objeções e scripts prontos. Otimize suas vendas!"}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/otimizacao-processos-clinicas",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Clínicas: ICP, Cadência e Scripts
...
[1] Pesquisa da Associação Brasileira de Clínicas (ABC), 2023.
[2] Relatório de Tendências em Saúde B2B da McKinsey & Company, 2022.
[3] Estudo sobre Desafios de Gestão em Clínicas Médicas, Conselho Federal de Medicina (CFM), 2024.
[4] Análise de Eficiência Operacional em Clínicas Odontológicas, Conselho Federal de Odontologia (CFO), 2023.
[5] Panorama da Saúde Suplementar no Brasil, Agência Nacional de Saúde Suplementar (ANS), 2024.
...
|---|---|---|---|---|
| **Dia 1** | LinkedIn | Conexão Personalizada | Iniciar relacionamento, demonstrar interesse genuíno. | Solicitação de conexão com mensagem curta e relevante, mencionando um ponto em comum ou interesse na área de atuação da clínica. Ex: "Prezado(a) [Nome], acompanho seu trabalho na [Nome da Clínica] e admiro [algo específico]. Gostaria de conectar para trocar ideias sobre [tópico relevante]." |
| **Dia 2** | E-mail | E-mail de Valor (Educação) | Apresentar um problema comum e uma possível solução, sem vender diretamente. | E-mail com um artigo, estudo de caso ou dado relevante sobre um desafio que a clínica provavelmente enfrenta (ex: otimização de agendamentos, retenção de pacientes). Terminar com uma pergunta aberta. Ex: "[Nome], percebo que muitas clínicas enfrentam [problema]. Compartilho este [recurso] que aborda [solução]. O que você pensa sobre isso?" |
| **Dia 4** | LinkedIn | Mensagem de Acompanhamento | Reforçar o e-mail anterior e oferecer mais valor. | Mensagem no LinkedIn referenciando o e-mail enviado e oferecendo um material complementar ou uma breve análise. Ex: "[Nome], enviei um e-mail há alguns dias sobre [tópico]. Anexei um breve [material] que pode ser útil. Alguma dúvida?" |
| **Dia 6** | E-mail | E-mail de Prova Social | Construir credibilidade e confiança. | E-mail com um depoimento, case de sucesso (anonimizado, se necessário) ou estatística de mercado que demonstre o impacto da sua solução em clínicas similares. Ex: "[Nome], uma clínica como a sua conseguiu [resultado] com nossa ajuda. Gostaria de compartilhar como. " |
...
| **Dia 10** | E-mail | E-mail de Reengajamento | Última tentativa de agregar valor antes de pausar. | E-mail com uma oferta de diagnóstico gratuito, convite para webinar ou um recurso exclusivo. Ex: "[Nome], caso ainda não tenhamos conseguido conversar, gostaria de oferecer um [diagnóstico gratuito/convite] para [benefício]." |
| **Dia 14** | LinkedIn | Mensagem de Despedida (ou Pausa) | Finalizar a cadência de forma profissional, deixando a porta aberta. | Mensagem agradecendo o tempo e informando que a prospecção será pausada, mas que a porta está aberta para contato futuro. Ex: "[Nome], entendo que sua agenda é corrida. Vou pausar nossos contatos por agora, mas se surgir a necessidade de [solução], estou à disposição." |
...
[6] Guia de Prospecção B2B para Saúde da HubSpot, 2023.
[7] Artigo sobre Tratamento de Objeções em Vendas B2B, SalesForce Blog, 2024.
...
*   **Script:**
    "Assunto: Ideias para otimizar a [Área de Atuação do Prospect, ex: captação de pacientes] na [Nome da Clínica]
...
*   **Script:**
    "Assunto: Acompanhamento: [Assunto da Ligação]
...
*   **Script:**
    "Assunto: Sobre o [Nome do Material] que você baixou
...
*   **Script:**
    "Olá [Nome do Prospect], sou [Seu Nome] da [Sua Empresa]. [Nome do Contato em Comum] sugeriu que eu entrasse em contato, ou nos conhecemos em [Nome do Evento].
...
*   **Script:**
    "Olá [Nome do Prospect], sou [Seu Nome] da [Sua Empresa]. Enviei um e-mail/tentei ligar sobre [assunto]. Gostaria de saber se seria um bom momento para uma mensagem rápida aqui sobre [benefício]."

[8] Relatório de Benchmarking de Vendas B2B, Gartner, 2023.
[9] Guia Completo de Scripts de Vendas, RD Station, 2024.
...
*   **Serviço:** [Otimização de Processos para Clínicas](/servicos/otimizacao-processos-clinicas)
*   **Guia:** [Marketing Digital para Clínicas: Estratégias e Ferramentas](/guias/marketing-digital-clinicas)
*   **Glossário:** [Glossário de Termos de Marketing e Vendas B2B](/glossario/termos-marketing-vendas-b2b)
*   **Conteúdo Relacionado:** [Como a LGPD Impacta a Prospecção no Setor de Saúde](/blog/lgpd-prospeccao-saude)
*   **Conteúdo Relacionado:** [A Importância do CRM na Gestão de Relacionamento com Clientes de Clínicas](/blog/crm-gestao-clientes-clinicas)
...
[8] Relatório de Benchmarking de Vendas B2B, Gartner, 2023.
[9] Guia Completo de Scripts de Vendas, RD Station, 2024.
[10] Pesquisa interna Manus AI sobre dúvidas comuns de clientes B2B no setor de saúde, 2024.`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(r,{currentUrl:"/guias/prospeccao-b2b-saude-clinicas",currentType:"guia",currentStage:"MOFU"})]})}export{b as default};
