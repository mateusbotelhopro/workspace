import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as i}from"./FunnelLinks-IeluMWpk.js";import{W as n}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Bancos: ICP, Cadência e Scripts",description:"Guia completo sobre prospecção B2B para bancos: defina seu ICP, crie cadências eficazes e use scripts que convertem. Otimize suas vendas no setor financeiro.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-financeiro-bancos"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Bancos: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B para bancos: defina seu ICP, crie cadências eficazes e use scripts que convertem. Otimize suas vendas no setor financeiro."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/como-funciona",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Bancos: ICP, Cadência e Scripts
...
|---|---|---|---|---|
| 1 | LinkedIn | Conexão Personalizada | Iniciar relacionamento | Mensagem curta e relevante, mencionando um ponto em comum ou um artigo recente do prospect. |
| 2 | Email | Introdução + Valor | Apresentar proposta de valor | Email conciso, destacando um desafio comum do setor bancário e como sua solução pode ajudar. |
| 4 | LinkedIn | Interação com Conteúdo | Manter engajamento | Curtir/comentar uma publicação do prospect ou compartilhar um artigo relevante para o setor. |
| 5 | Email | Case de Sucesso | Prova social | Email com um breve case de sucesso de um banco similar, focado em resultados. |
| 7 | Telefone | Tentativa de Contato | Conversa direta | Ligação rápida para verificar se o email foi recebido e oferecer ajuda. |
| 10 | Email | Recurso Educacional | Nutrir o lead | Enviar um e-book, webinar ou estudo de mercado relevante para os desafios do prospect. |
| 14 | LinkedIn | Última Tentativa | Chamada para ação | Mensagem final, reforçando o valor e sugerindo uma breve conversa para explorar sinergias. |
...
| KPI | Descrição | Importância no Setor Bancário |
|---|---|---|
| **Taxa de Conversão de Lead para Oportunidade** | Percentual de leads qualificados que se tornam oportunidades de vendas. | Indica a eficácia da qualificação inicial e do alinhamento com o ICP. |
| **Duração do Ciclo de Vendas** | Tempo médio desde o primeiro contato até o fechamento do negócio. | Ajuda a prever receitas e a otimizar o processo de vendas, que é naturalmente mais longo em bancos. |
...
| **Taxa de Engajamento da Cadência** | Percentual de prospects que respondem ou interagem com os toques da cadência. | Avalia a relevância e a eficácia das mensagens e canais utilizados. |
...
- [Serviço: Otimização de Prospecção B2B para o Setor Financeiro](/servicos/otimizacao-prospeccao-financeiro)
- [Guia: Prospecção B2B para Consultorias: ICP, Cadência e Scripts](/guias/prospeccao-b2b-consultorias)
- [Glossário: Termos Essenciais de Prospecção B2B](/glossario/termos-prospeccao-b2b)
- [Conteúdo Relacionado: A Importância da Personalização na Prospecção B2B](/blog/personalizacao-prospeccao-b2b)
- [Conteúdo Relacionado: Como Construir um ICP Eficaz para Empresas B2B](/blog/construir-icp-eficaz)
