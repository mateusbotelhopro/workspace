import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Escolas de Idiomas: ICP, Cadência e Scripts",description:"Guia completo sobre prospecção B2B para escolas de idiomas. Aprenda a definir seu ICP, cadências de contato e scripts eficazes para LinkedIn, Email e WhatsApp.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-educacao-idiomas"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Escolas de Idiomas: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B para escolas de idiomas. Aprenda a definir seu ICP, cadências de contato e scripts eficazes para LinkedIn, Email e WhatsApp."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/consultoria-prospeccao-educacao",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Escolas de Idiomas: ICP, Cadência e Scripts
...
|---|---|---|---|---|
| 1 | LinkedIn | Conexão Personalizada | Iniciar relacionamento | Mencionar interesse mútuo ou conexão relevante. |
| 2 | Email | Introdução Curta | Apresentar valor | Foco na dor e solução, sem venda direta. |
| 4 | LinkedIn | Mensagem de Valor | Reforçar proposta | Compartilhar artigo relevante ou insight. |
| 5 | Email | Case de Sucesso | Prova social | Apresentar um case de sucesso similar. |
| 7 | Telefone | Ligação Curta | Qualificação | Tentar um contato rápido para qualificar. |
| 10 | Email | Oferta de Conteúdo | Gerar engajamento | Oferecer um e-book, webinar ou diagnóstico gratuito. |
| 14 | LinkedIn | Último Toque | Reengajamento | Perguntar se há interesse em uma conversa rápida. |

**Referências:**
[1] [Estudo de Mercado do Setor de Educação Corporativa](https://www.example.com/estudo-educacao-corporativa)
[2] [Guia Completo de ICP para Vendas B2B](https://www.example.com/guia-icp-b2b)
[3] [Melhores Práticas em Cadências de Prospecção](https://www.example.com/cadencias-prospeccao)
...
**Referências:**
[4] [Guia Completo de Tratamento de Objeções em Vendas B2B](https://www.example.com/tratamento-objecoes-b2b)
[5] [KPIs Essenciais para Vendas e Marketing B2B](https://www.example.com/kpis-vendas-b2b)
[6] [Modelos de Scripts de Prospecção para Diferentes Canais](https://www.example.com/scripts-prospeccao)
...
*   [Serviço: Consultoria de Prospecção B2B para Educação](/servicos/consultoria-prospeccao-educacao)
*   [Guia: Como Construir um ICP Eficaz para Vendas B2B](/guias/como-construir-icp-vendas-b2b)
*   [Glossário: Termos Essenciais de Vendas e Marketing B2B](/glossario/termos-vendas-marketing-b2b)
*   [Conteúdo Relacionado: Estratégias de Marketing Digital para Escolas de Idiomas](/blog/marketing-digital-escolas-idiomas)
*   [Conteúdo Relacionado: A Importância do Follow-up na Prospecção B2B](/blog/importancia-follow-up-prospeccao-b2b)
`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-educacao-idiomas",currentType:"guia",currentStage:"MOFU"})]})}export{b as default};
