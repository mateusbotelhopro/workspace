import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function h(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para MarTech: ICP, Cadência e Scripts",description:"Guia completo sobre prospecção B2B para MarTech. Aprenda a definir seu ICP, construir cadências eficazes e usar scripts para engajar CMOs e Heads de Growth.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-saas-martech"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para MarTech: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B para MarTech. Aprenda a definir seu ICP, construir cadências eficazes e usar scripts para engajar CMOs e Heads de Growth."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para MarTech: ICP, Cadência e Scripts
...
|---|---|---|---|---|
| 1 | LinkedIn | Conexão Personalizada | Iniciar relacionamento | Mensagem curta e relevante, mencionando um ponto em comum ou interesse mútuo. |
| 2 | Email | Email de Valor (Educacional) | Oferecer insight | Artigo, estudo de caso ou webinar relevante para a dor do prospect. |
| 4 | LinkedIn | Interação em Conteúdo | Gerar visibilidade | Comentar em uma publicação do prospect ou compartilhar conteúdo relevante. |
| 5 | Email | Email de Follow-up (Problema/Solução) | Reforçar valor | Conectar a solução a uma dor específica do prospect. |
| 7 | Telefone | Ligação Curta (Permissão) | Agendar conversa | Perguntar se é um bom momento para uma breve conversa sobre um desafio específico. |
| 10 | Email | Email de Prova Social | Construir confiança | Depoimento, case de sucesso ou estatística de mercado. |
| 14 | LinkedIn | Mensagem de Despedida/Última Tentativa | Deixar porta aberta | Oferecer recursos adicionais e indicar que fechará o ciclo de prospecção. |
