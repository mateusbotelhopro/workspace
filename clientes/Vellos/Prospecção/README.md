...
```bash
python3 ~/.claude/skills/limpar-listas/scripts/limpar.py --input "<arquivo em A Processar/>" --output-dir "clientes/Vellos/Prospecção/Processadas/<nome-da-lista>" --title "<Nome da Lista>"
```
