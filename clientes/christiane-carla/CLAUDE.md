...
- **Nome:** Christiane Carla
- **Segmento:** Advocacia — Direito Digital, Propriedade Intelectual e Direito Empresarial
- **Marca secundária (LPs):** Chris do Digital
- **OAB:** MG 226.655
- **Localização:** Minas Gerais, Brasil
- **Contato principal:** Christiane Carla
- **WhatsApp:** +55 31 97246-2290
...
| Site | Domínio | Tipo |
|------|---------|------|
| Institucional | christianecarla.adv.br | React SPA (Vite) — Negócios e Propriedade Intelectual |
| LP Golpe do Pix | pix.christianecarla.adv.br | HTML estático — captação fraude bancária |
| LP Recuperação de Contas | recupera.christianecarla.adv.br | HTML estático — captação contas hackeadas |

## Redes sociais

- **Instagram institucional:** @christianecarla.adv
- **Instagram LPs:** @chrisdodigital
- **LinkedIn:** linkedin.com/in/christiane-carla-a0a32b2ba/
- **Facebook:** facebook.com/chrisdodigital
...
**Paleta das LPs (Chris do Digital):**
- Dark: #161616
- Brown: #7d4a29
- Beige: #ede2d1
- White: #ffffff
...
**Site institucional (christianecarla.adv.br):**
- Theme color: #1a2744 (azul escuro/navy)
...
Serviço pontual — apenas criação de site e landing pages.
