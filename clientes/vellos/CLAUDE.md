...
Nomes de pasta em kebab-case minúsculo sem acento, seguindo o padrão geral do BotelhoOS. Exceção: `vellosleads.com.br/` (espelha as URLs reais do site no ar — build publicado, não renomear nada dentro).
...
Lotes de conteúdo (carrosséis, posts estáticos) ficam em `conteudo/` dentro dessa pasta, com README próprio explicando a estrutura e como regerar as artes.
