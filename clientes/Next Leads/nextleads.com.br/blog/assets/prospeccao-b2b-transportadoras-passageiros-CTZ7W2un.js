import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as i}from"./FunnelLinks-IeluMWpk.js";import{W as n}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Transportadoras de Passageiros",description:"Guia completo sobre prospecção B2B para transportadoras de passageiros. Aprenda a definir seu ICP, cadências eficazes e scripts de vendas.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-transportadoras-passageiros"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Transportadoras de Passageiros: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B para transportadoras de passageiros. Aprenda a definir seu ICP, cadências eficazes e scripts de vendas."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Transportadoras de Passageiros: ICP, Cadência e Scripts
...
[1] [Guia de prospecção B2B para transportadoras](/segmentos/transportadoras)
[2] [Prospecção comercial B2B](/guias/prospeccao-comercial-b2b)
[3] [Serviço de prospecção ativa B2B](/servicos/prospeccao-ativa-b2b)
