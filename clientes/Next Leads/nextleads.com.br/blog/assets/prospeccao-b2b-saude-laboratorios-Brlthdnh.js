import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function v(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Laboratórios: ICP, Cadência e Scripts",description:"Guia completo sobre prospecção B2B para laboratórios de análises clínicas. Aprenda a definir seu ICP, cadências eficazes e scripts de vendas para LinkedIn, Email e WhatsApp.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-saude-laboratorios"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Laboratórios: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B para laboratórios de análises clínicas. Aprenda a definir seu ICP, cadências eficazes e scripts de vendas para LinkedIn, Email e WhatsApp."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Laboratórios: ICP, Cadência e Scripts
...
| :-- | :---- | :------------ | :------- | :---------------- |
| 1 | LinkedIn | Conexão + Mensagem | Introdução e valor | Pedido de conexão personalizado, seguido de mensagem breve sobre um desafio comum do ICP e como seu laboratório pode ajudar. |
| 2 | Email | Email 1 (Valor) | Apresentar solução | Email com um estudo de caso ou dado relevante sobre eficiência/qualidade que seu laboratório oferece. |
| 4 | LinkedIn | Interação | Engajamento | Curtir/comentar uma publicação recente do lead ou de sua empresa. Enviar mensagem com um artigo relevante. |
| 5 | Email | Email 2 (Benefício) | Reforçar benefício | Email focando em um benefício específico (ex: redução de custos, agilidade) e um convite para um breve call. |
| 7 | Telefone | Ligação (Curta) | Qualificação | Ligação rápida para verificar interesse e agendar uma conversa mais aprofundada. Deixar voicemail se não atender. |
| 10 | Email | Email 3 (Prova Social) | Credibilidade | Email com depoimento de cliente similar ou selos de acreditação/certificações. |
| 14 | LinkedIn | Mensagem Final | Última Tentativa | Mensagem final no LinkedIn, oferecendo recursos adicionais ou um último convite para conversa, respeitando o tempo do lead. |
