import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function b(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Farmácias: ICP, Cadência e Scripts",description:"Descubra estratégias de prospecção B2B para farmácias, incluindo ICP, cadência de vendas e scripts prontos. Otimize suas vendas no setor farmacêutico.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-saude-farmacias"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Farmácias: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Descubra estratégias de prospecção B2B para farmácias, incluindo ICP, cadência de vendas e scripts prontos. Otimize suas vendas no setor farmacêutico."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/como-funciona",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Farmácias: ICP, Cadência e Scripts
...
| Dia | Canal | Ação |
| :-- | :--- | :--- |
| 1 | LinkedIn | **Conexão:** Enviar convite de conexão para o decisor (Dr. Carlos, Ana Paula, Dr. Roberto) com uma nota personalizada. |
| 2 | E-mail | **Introdução:** Enviar um e-mail de apresentação focado em uma dor específica da persona, oferecendo um insight valioso. |
| 4 | LinkedIn | **Interação:** Curtir ou comentar uma publicação do decisor ou da empresa para manter a presença. |
| 6 | E-mail | **Follow-up com Valor:** Enviar um segundo e-mail com um estudo de caso ou um artigo relevante sobre o setor farmacêutico. |
| 9 | WhatsApp | **Contato Direto (com permissão):** Se houver abertura, enviar uma mensagem curta e objetiva, mencionando os contatos anteriores. |
| 12 | E-mail | **Última Tentativa:** Enviar um e-mail de "break-up" educado, perguntando se o tema não é relevante no momento. |
| 14 | LinkedIn | **Manter Contato:** Continuar interagindo de forma sutil com as publicações do decisor para manter o relacionamento. |
...
3.  **"Estou muito ocupado, não tenho tempo para isso."**
...
4.  **"Envie-me um e-mail com mais informações."**
...
5.  **"Não vejo como isso pode funcionar na minha farmácia."**
...
6.  **"Nossa equipe é resistente a novas tecnologias."**
...
Scripts de prospecção personalizados são vitais porque demonstram que o prospector entende as **dores e necessidades específicas** do setor farmacêutico. Eles permitem uma comunicação mais **relevante e consultiva**, aumentando a probabilidade de engajamento. Ao invés de mensagens genéricas, scripts adaptados abordam diretamente os desafios de gestão, regulamentação e concorrência que as farmácias enfrentam, construindo **credibilidade e confiança**.`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-saude-farmacias",currentType:"guia",currentStage:"MOFU"})]})}export{b as default};
