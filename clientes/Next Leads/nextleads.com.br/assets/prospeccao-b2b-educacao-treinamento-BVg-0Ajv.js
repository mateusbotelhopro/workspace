import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-BbbFHRus.js";import{F as i}from"./FunnelLinks-AtCLZNho.js";import{W as n}from"./index-ipOPkdiw.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-GhauihFT.js";function x(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Treinamento: ICP, Cadência e Scripts",description:"Aprenda as melhores estratégias de prospecção B2B para o setor de treinamento, incluindo ICP, cadência, scripts e tratamento de objeções. Guia completo para consultoras e heads de operação.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-educacao-treinamento"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Treinamento: Estratégias Essenciais para o Sucesso"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Aprenda as melhores estratégias de prospecção B2B para o setor de treinamento, incluindo ICP, cadência, scripts e tratamento de objeções. Guia completo para consultoras e heads de operação."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b-treinamento",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Prospecção B2B para Treinamento: Estratégias Essenciais para o Sucesso
...
| :-- | :--- | :--- | :--- |
| 1 | 1 | LinkedIn | Conectar-se com o prospect e iniciar o relacionamento. |
| 2 | 2 | Email | Enviar um email de apresentação focado na dor do prospect. |
| 4 | 3 | LinkedIn | Engajar com o conteúdo do prospect (curtir, comentar). |
| 6 | 4 | Email | Enviar um email de follow-up com um case de sucesso relevante. |
| 9 | 5 | Telefone | Realizar uma chamada rápida para apresentar a solução e qualificar. |
| 12 | 6 | WhatsApp | Enviar uma mensagem curta e personalizada para agendar uma conversa. |
| 14 | 7 | Email | Enviar um email de "break-up" amigável, deixando a porta aberta. |
...
> Olá [Nome do Prospect], notei seu trabalho em [mencionar algo específico]. Gostaria de me conectar.
> Atenciosamente, [Seu Nome]

#### 2. Mensagem Inicial

> Olá [Nome do Prospect], obrigado(a) por aceitar a conexão! Ajudamos empresas como a sua a [benefício específico]. Podemos conversar por 15 minutos para explorar sinergias?
> Atenciosamente, [Seu Nome]

#### 3. Follow-up

> Olá [Nome do Prospect], rápido follow-up. Compartilho um artigo/insight sobre [tópico relevante]: [Link]. Se fizer sentido, estou à disposição.
> Atenciosamente, [Seu Nome]
...
> **Assunto:** [Nome da Empresa do Prospect]: Otimizando [Área de Dor]
> Prezado(a) [Nome do Prospect], sou [Seu Nome] da [Sua Empresa]. Ajudamos empresas como a sua a [1-2 benefícios claros], com [resultado quantificável]. Podemos conversar por 20 minutos para apoiar a [Nome da Empresa do Prospect]?
> Atenciosamente, [Seu Nome], [Seu Cargo], [Sua Empresa], [Seu Telefone]

#### 5. Follow-up 1

> **Assunto:** Re: [Nome da Empresa do Prospect]: Otimizando [Área de Dor]
> Prezado(a) [Nome do Prospect], rápido follow-up. [Reafirmar dor principal] é prioridade? Se sim, estou à disposição.
> Atenciosamente, [Seu Nome]

#### 6. Follow-up 2 (com conteúdo de valor)

> **Assunto:** Um insight sobre [Tópico Relevante] para [Nome da Empresa do Prospect]
> Prezado(a) [Nome do Prospect], pensei em você ao ler este [artigo/estudo de caso] sobre [tópico relevante]: [Link]. Se houver interesse, estou à disposição.
> Atenciosamente, [Seu Nome]

#### 7. Email de Reengajamento

> **Assunto:** Pensando na [Nome da Empresa do Prospect] e [Tópico Relevante]
> Prezado(a) [Nome do Prospect], acompanhei as novidades no setor de [setor do prospect]. Ajudamos empresa similar à sua a [resultado impressionante]. Se aprimorar a [área de dor] é prioridade, adoraria retomar.
> Atenciosamente, [Seu Nome]
