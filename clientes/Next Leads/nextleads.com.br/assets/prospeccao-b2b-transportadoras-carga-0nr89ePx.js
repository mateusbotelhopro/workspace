import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as r}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as i}from"./FunnelLinks-IeluMWpk.js";import{W as t}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function x(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(r,{title:"Prospecção B2B para Transportadoras: ICP, Cadência e Scripts",description:"Guia completo sobre prospecção B2B para transportadoras de carga. Aprenda a definir seu ICP, criar cadências eficazes e usar scripts de vendas para otimizar resultados.",canonical:"https://nextleads.com.br/guias/prospeccao-b2b-transportadoras-carga"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Prospecção B2B para Transportadoras de Carga: ICP, Cadência e Scripts"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Guia completo sobre prospecção B2B para transportadoras de carga. Aprenda a definir seu ICP, criar cadências eficazes e usar scripts de vendas para otimizar resultados."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b-transportadoras",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(t,{children:`# Prospecção B2B para Transportadoras de Carga: ICP, Cadência e Scripts
...
| Dia | Canal | Ação | Objetivo | Conteúdo | Observações |
|---|---|---|---|---|---|
| 1 | LinkedIn | Conexão + Mensagem Personalizada | Iniciar relacionamento | Mensagem curta, focada em um ponto de dor comum | Mencionar conexão mútua ou interesse em comum |
| 2 | Email | Email de Apresentação | Apresentar valor e agendar conversa | Foco em um benefício chave, com CTA claro | Personalizar com base na pesquisa do ICP |
| 4 | LinkedIn | Comentário em Post/Artigo | Gerar engajamento | Adicionar valor à discussão do prospect | Não ser promocional |
| 5 | Email | Follow-up 1 | Reforçar mensagem anterior | Relembrar benefício e CTA, adicionar um novo insight | Pode incluir um case de sucesso curto |
| 7 | Telefone | Ligação Curta | Tentar contato direto | Apresentação rápida, foco em agendamento | Deixar voicemail se não atender, com breve resumo |
| 9 | Email | Follow-up 2 | Oferecer recurso de valor | Compartilhar artigo, estudo de caso ou webinar | Posicionar como especialista, sem pressão de venda |
| 12 | LinkedIn | Mensagem de Valor | Último toque antes de "quebrar" a cadência | Oferecer ajuda ou recurso final | Perguntar se há interesse em explorar soluções |
| 14 | Email | Email de "Breakup" | Finalizar cadência, deixar porta aberta | Mensagem curta, sem pressão, com CTA para futuro | Pode ser o último contato por um tempo |
...
6.  **É eficaz usar o WhatsApp para prospecção B2B no setor de transportes?**
    *   Sim, o WhatsApp pode ser muito eficaz, especialmente para follow-ups rápidos e comunicação direta, desde que usado de forma profissional e respeitosa. É ideal para agendamentos, envio de informações rápidas e para manter um relacionamento mais próximo, mas sempre com a permissão do prospect e evitando mensagens excessivas.`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(i,{currentUrl:"/guias/prospeccao-b2b-transportadoras-carga",currentType:"guia",currentStage:"MOFU"})]})}export{x as default};
