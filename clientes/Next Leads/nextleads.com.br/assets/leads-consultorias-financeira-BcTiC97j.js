import{j as e,L as a}from"./react-vendor-zTf2QiWo.js";import{S as i}from"./SEO-Dh6kmgkR.js";import{B as o}from"./index-Byb5O0fm.js";import{F as r}from"./FunnelLinks-IeluMWpk.js";import{W as n}from"./index-iDl5n-Fs.js";import{A as s}from"./ui-vendor-WFwuDEIY.js";import"./charts-vendor-DRcgG4uA.js";import"./data-vendor-CHHh1G4l.js";import"./card-DqD4jgU1.js";function q(){return e.jsxs("div",{className:"flex flex-col w-full",children:[e.jsx(i,{title:"Geração de Leads para Consultorias Financeiras: Estratégia B2B",description:"Desbloqueie o crescimento para sua consultoria financeira com prospecção B2B de alta performance. Conecte-se a decisores e acelere seu ciclo de vendas.",canonical:"https://nextleads.com.br/segmentos/leads-consultorias-financeira"}),e.jsx("section",{className:"relative min-h-[60vh] flex items-center bg-gradient-to-r from-primary/10 to-secondary/10 py-20",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"max-w-3xl",children:[e.jsx("h1",{className:"text-5xl md:text-6xl font-bold mb-6 leading-tight",children:"Geração de Leads para Consultorias Financeiras: Estratégia B2B"}),e.jsx("p",{className:"text-xl text-muted-foreground mb-8",children:"Desbloqueie o crescimento para sua consultoria financeira com prospecção B2B de alta performance. Conecte-se a decisores e acelere seu ciclo de vendas."}),e.jsxs("div",{className:"flex flex-col sm:flex-row gap-4",children:[e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})}),e.jsx(a,{href:"/servicos/prospeccao-b2b-financeiro",children:e.jsx(o,{variant:"outline",size:"lg",className:"rounded-none px-8 py-6",children:"Ver como funciona"})})]})]})})}),e.jsx("section",{className:"py-20",children:e.jsx("div",{className:"container max-w-3xl",children:e.jsx(n,{children:`# Geração de Leads para Consultorias Financeiras: Estratégia B2B

## Hero com Proposta Única

**Desbloqueie o Crescimento Exponencial para Sua Consultoria Financeira com Prospecção B2B de Alta Performance.**
...
*   [Serviço: Prospecção B2B para o Setor Financeiro](/servicos/prospeccao-b2b-financeiro)
*   [Guia: Como Construir um ICP Eficaz para Consultorias](/guias/icp-consultorias)
*   [Glossário: Termos Essenciais de Geração de Leads B2B](/glossario/geracao-leads-b2b)
*   [Artigo: O Impacto da Inteligência de Dados na Prospecção Financeira](/blog/inteligencia-dados-prospeccao-financeira)
*   [Case de Sucesso: Como a Consultoria X Acelerou seu Crescimento com Nossas Estratégias](/cases/consultoria-x-crescimento)

## CTA Final Forte

**Pronto para Transformar Sua Prospecção e Acelerar o Crescimento da Sua Consultoria Financeira?**

Não deixe mais oportunidades escaparem. Agende um diagnóstico gratuito com nossos especialistas e descubra como podemos construir uma máquina de prospecção B2B personalizada para sua consultoria. Comece hoje a construir um futuro de crescimento previsível e lucrativo.

[Agendar diagnóstico](/contato)

[Ver como funciona](/servicos/prospeccao-b2b-financeiro)
`})})}),e.jsx("section",{className:"py-20 bg-primary/5",children:e.jsxs("div",{className:"container max-w-3xl text-center",children:[e.jsx("h2",{className:"text-3xl font-bold mb-6",children:"Pronto para começar?"}),e.jsx("p",{className:"text-lg text-muted-foreground mb-8",children:"Agende uma reunião com nossos especialistas."}),e.jsx(a,{href:"/contato",children:e.jsxs(o,{size:"lg",className:"rounded-none px-8 py-6",children:["Agendar diagnóstico",e.jsx(s,{className:"ml-2 h-5 w-5"})]})})]})}),e.jsx(r,{currentUrl:"/segmentos/leads-consultorias-financeira",currentType:"servico",currentStage:"BOFU"})]})}export{q as default};
