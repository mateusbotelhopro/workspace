...
- **Nome:** Carlah Campos
- **Segmento:** Neuroaroma — cursos e formações sobre aromaterapia aplicada à neurociência
- **Contato principal:** Carlah Campos
- **Início do trabalho:** Junho/2026
- **Produto principal:** Neuroaroma Pro (lançamento)
...
- Google Ads — Customer ID: 9583614039
- Meta Ads — Ad Account ID: [a definir]
- Instagram/Facebook Page: [a definir]

## Funil de lançamento (NeuroAroma 26)

Domínio: `universidadearomatica.com.br` (prefixo `/20` em todas as páginas — não remover)

**Captação:** e-book (`/20/e-bookneuro26`) e webinar (`/20/webinarneuro26`)
**Pós-captação:** páginas de obrigado (`/20/obrigadoebookneuro26`, `/20/obrigadowebinarneuro26`)
**Vendas:** imersão (`/20/imersaoneuro26`), Neuroaroma PRO (`/20/neuroaromapro26`), upsell com desconto (`/20/neuroaroma26-desconto`)
**Webinar (vídeo):** `youtu.be/fokq60Bmk_o`

Detalhes completos dos links em [Links do funil - NeuroAroma 26.md](Links%20do%20funil%20-%20NeuroAroma%2026.md).

## Tom de voz deste cliente

[a definir — segue o padrão do sistema até receber referência da cliente]

## Identidade visual

[a definir — aguardando materiais da cliente]
...
- Lançamento ativo do Neuroaroma Pro (Junho/2026)
- Tráfego rodando em Meta Ads e Google Ads simultaneamente
- Três páginas de captação: e-book, webinar, imersão

[Complementar conforme o lançamento avançar]
